...
namespace RobotStore.WebService.Controllers
{
    public class UsersController : ApiController
    {
        ...
        //public UsersController(RobotStoreContext context)
        //{
        ...
        {
            return dal.GetUsers().AsQueryable();
        }
        ...
        {
            User user = dal.GetUsers().Find(x => x.Id == id);
            if (user == null)
            {
                return NotFound();
            }
        ...
        public IHttpActionResult GetUser(string login, string password)
        {
            ...
            User user = dal.GetUser(login, password);
            if (user == null)
            {
                return NotFound();
            }
